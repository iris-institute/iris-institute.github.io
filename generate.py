...
SERIES = [
    ...
    {
        'slug': 'latin-america',
        'seo_title': '中南米を読み解く 4冊——ブラジル・メキシコ・ベネズエラ・Decoding Mexico',
        'meta_desc': 'ブラジル・メキシコ・ベネズエラをそれぞれ1冊で。歴史・地理・文化・政治・経済の5つの視点でラテンアメリカ主要国を体系的に理解できる書籍シリーズ。BRICS外交・ニアショアリング・資源国家崩壊・麻薬カルテル・アマゾンなど現代の中南米論点を網羅。',
        'h1': '中南米を読み解く 4冊',
        'hero_sub': 'BRICSの旗手ブラジル、ニアショアリングで注目のメキシコ、崩壊した産油国ベネズエラ——ラテンアメリカを構造から。',
        'hero_desc': 'ラテンアメリカは日本から見て地理的に最も遠く、情報も入りにくい地域です。しかしブラジルはBRICS＋の中核として世界の南半球を代表する立場に立ち、メキシコはUSMCA体制下でアジアの製造業移転先として急浮上し、ベネズエラは世界最大の原油埋蔵量を持ちながら崩壊した国家として現代政治学の重要ケースになっています。Iris Instituteのラテンアメリカ書籍は、こうした国々を歴史・地理・文化・政治・経済の5つの視点で構造から解説しています。今後アルゼンチン・チリ・コロンビアなどの主要国も順次追加予定です。',
        'sections': [
            {'kind': 'books', 'title': '現在の刊行タイトル', 'desc': 'まずはこの4冊から。今後アルゼンチン・チリ・コロンビア・パラグアイなどを追加予定。',
             'slugs': ['brazil', 'mexico', 'venezuela', 'decoding-mexico']},
            {'kind': 'guide', 'title': '目的別の読み方', 'cards': [
                {'title': 'BRICS＋と南米の大国', 'html': '<a href="../../books/brazil.html">ブラジル</a>は南米大陸の半分を占めるBRICS＋の主要国。Pixによるフィンテック革命、アマゾンとCOP30、270万人の世界最大の日系社会——大陸国家の全体像を1冊で。'},
    ...
    {
        'slug': 'brics-plus',
        'seo_title': 'BRICS+を読む 4冊——中国・ロシア・インド・ブラジル',
        'meta_desc': '中国・ロシア・インド・ブラジルを、それぞれ1冊で。米国主導の国際秩序に対抗する新興国連合BRICS+の主要プレイヤーを、歴史・地理・文化・政治・経済の5つの視点で体系的に理解する書籍シリーズ。南アフリカは今後刊行予定。',
        'h1': 'BRICS+を読む 4冊——中国・ロシア・インド・ブラジル',
        'hero_sub': '西側主導の世界に対抗する新興国連合。その中核4カ国を1冊ずつ。',
        'hero_desc': 'BRICS+は、中国・ロシア・インド・ブラジル・南アフリカに、2024年以降イラン・エジプト・エチオピア・UAEなどが加わった新興国連合です。人口では世界の45%超、GDPではG7を上回る規模となり、米国主導の国際秩序に対抗する枠組みとして急速に存在感を増しています。ただし内部は決して一枚岩ではなく、中国とインドは国境紛争を抱え、ロシアとインドの関係は複雑で、脱ドル化の実現度も国によって温度差があります。Iris Instituteは、BRICS+の中核4カ国（中国・ロシア・インド・ブラジル）を、それぞれ1冊で書き下ろしました。南アフリカも今後刊行予定です。',
        'sections': [
            {'kind': 'books', 'title': 'BRICS中核4カ国', 'desc': '人口・GDP・国際的影響力で圧倒的な4カ国。それぞれの内部構造と国際戦略を1冊ずつ。',
             'slugs': ['china', 'russia', 'india', 'brazil']},
            {'kind': 'guide', 'title': '目的別の読み方', 'cards': [
                ...
                {'title': '南半球の大国ブラジル', 'html': '<a href="../../books/brazil.html">ブラジル</a>はBRICS拡大の推進役として2025年議長国を務め、グローバルサウスの盟主を自任。中国最大の農産品輸出先でありながら米国とも関係を維持する、独特の外交自律性を持つ大国です。'},
                {'title': 'BRICS内部の不協和音', 'html': '中国とインドはヒマラヤ国境で軍事衝突を繰り返し、ロシアはウクライナ戦争で外交的に孤立気味。BRICSは一枚岩ではなく、4冊読むと内部の緊張関係がよく見えます。'},
            ]},
            {'kind': 'related_series', 'links': [
                ('international-affairs', '地政学・国際情勢の書籍リストを見る'),
                ('east-asia', '東アジア5カ国シリーズを見る'),
